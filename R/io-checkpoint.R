...
#' registry) to a single `.qs` file for fast reload. Recommended after each
...
#' @param path File path ending in `.qs`.
...
#'
#' @param path Path to a `.qs` file saved by [save_checkpoint()].
